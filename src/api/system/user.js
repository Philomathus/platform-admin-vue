...
export function getUser(userId) {
  return request({
    url: '/platform/system/user/' + praseStrEmpty(userId),
    method: 'get'
  })
}
...
export function exportUser(query) {
  return request({
    url: '/platform/system/user/export',
    method: 'get',
    params: query
  })
}
...
export function resetUserPwd(userId, password) {
  ...
  return request({
    url: '/platform/system/user/resetPwd',
    method: 'put',
    data: data
  })
}
...
export function changeUserStatus(userId, status) {
  ...
  return request({
    url: '/platform/system/user/changeStatus',
    method: 'put',
    data: data
  })
}
...
export function importTemplate() {
  return request({
    url: '/platform/system/user/importTemplate',
    method: 'get'
  })
}
