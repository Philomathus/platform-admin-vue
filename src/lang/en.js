export default {
  ...
  members: {
    ...
    memberInfo: {
      ...
      more: {
        ...
        rpc: 'Reset Password Code',
        pgvc: 'Please enter Google Verification Code',
        prpc: 'Please enter Reset Password Code',
        gqrc: 'Get QR Code',
        rpcv: 'Valid for 5 minutes',
        sMess: 'SMS Message',
  ...
  pay: {
    ...
    configBank: {
      bc: 'Bank Code',
      pebc: 'Please enter the bank code',
      bn: 'Bank Name',
      pebn: 'Please enter the name of your bank',
      bowa: 'Bank official website address',
      sb: 'Sort by',
      ban: 'Bank Account Number',
      ah: 'Account Holder',
      mol: 'Minimum Open Level',
      maxl: 'Maximum Open Level',
      mta: 'Minimum top-up amount',
      maxt: 'Maximum top-up amount',
      txt: 'Text',
      psbn: 'Please select a bank name',
      peba: 'Please enter your bank account number',
      sn: 'Sort Number',
      pesn: 'Please enter the sort number',
      ri: 'Remark Information',
      peni: 'Please enter note information',
      peah: 'Please enter the account holder',
      aoa: 'Account Opening Address',
      peaa: 'Please enter your account address',
      pr: 'Preferential Ratio',
      pedp: 'Please enter the discount percentage',
      ol: 'Open Levels',
      pemol: 'Please enter the minimum open level',
      pemxol: 'Please enter the maximum open level',
      al: 'Amount limit',
      pemra: 'Please enter the minimum recharge amount',
      pemxra: 'Please enter the maximum recharge amount',
      pres: 'Province Restrictions',
      ucts: 'Use comma (,) to split, no restriction if empty',
      gc: 'Google Captcha',
      pegac: 'Please enter Google Authentication Code',
      det: 'Determine',
      t2: 'Text 2',
    ...
    memberDepositLog:{
      midan: 'Member ID/Account Number',
      pstd: 'Please select the type of deposit',
      peac: 'Please enter additional comments',
      pepn: 'Please enter a payment note',
      peon: 'Please enter order notes',
      peto: 'Please enter the operator',
      mn: 'Membership Number',
      ma: 'Member Account',
      dt: 'Deposit Type',
      aep: 'Amount of extra points',
      ecr: 'Extra Credit Remark',
      pr: 'Payment Remarks',
      or: 'Order Remarks',
      cm: 'Coding Multiplier',
      sip: 'Submit IP',
      opt: 'Operators',
      ct: 'Creation Time',
      pemn: 'Please enter your membership number',
      pema: 'Please enter your member account',
      pea: 'Please enter the amount of extra points',
      rem: 'Remarks',
      pen: 'Please enter a note',
      pecm: 'Please enter the code multiplier',
    ...
    memberPayJour:{
      ...
      pc: 'Payment Channels',
      miman: 'Member ID/Member Account Number',
      uon: 'Upstream Order Number/Order Number',
      rr: 'Record Refresh',
      ti: 'Time Interval',
      fs: '5 Seconds',
      ts: '10 Seconds',
      ...
      ot: 'Order Time',
      ut: 'Update Time',
      upon: 'Upstream order number',
      rem: 'Remarks',
      opt: 'Operation',
      mor: 'Manual Order Replacement',
      ps: 'Payment Status',
      aaa: 'Actual Arrival Amount',
      peta: 'Please enter the actual arrival amount',
      gc: 'Google Captcha',
      pegvc: 'Please enter Google Verification Code',
      sref: 'Start Refreshing',
      tac: 'The actual arrival amount cannot be empty',
      gce: 'Google Captcha cannot be empty',
      onu: 'Only number and underscores can be entered ' +
        'for member ID/member account',
      cpe: 'Confirm processing Excel and download, there will be a ' +
        'delay then there is a large amount of data, please be patient...',
      otu: 'Online top-up',
      fail: 'Failure',
      tbc: '待确认',
      stor: 'Stop Refreshing',
    ...
    memberRechargeLog:{
      ...
      as: 'All States',
      on: 'Order Number',
      mima: 'Member ID/Member Account Number',
      ry: 'Recharge￥',
      zy: 'Zone￥',
      bp: 'Bank-Payee',
      rec: 'Recharger',
      ...
      fa: 'Final Approval',
      adp: 'Audit does not pass',
      reco: 'Recovery',
      rpa: 'Reasons for not passing the audit',
      psr: 'Please select the reason for not passing',
      phn: 'Please enter a handwritten note',
      sref: 'Start Refreshing',
      adn: 'Audit does not pass the reason can not be empty',
      onu: 'Only numbers and underscores can be entered for member ID/member account',
      pec: 'Please enter the correct recharge amount range value',
      rs: 'Replication Success',
      mcdi: 'Modify company deposit information',
      cpe: 'Confirm processing Excel and download, there will be a delay when there is a large amount of data, please be patient...',
      cd: 'Company Deposit',
      stor: 'Stop Refreshing',
      rsas: 'Refresh starts after seconds',
