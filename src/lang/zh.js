export default {
  ...
  pay: {
    ...
    memberDepositLog:{
      ...
      pesip: '请输入提交IP',
      rd: '备注字典(1 人工入款)',
      pecd: '请输入备注字典(1 人工入款 2线上入款 3线下入款)',
      md: '人工入款',
      maco: '会员ID/账号只能输入数字及下划线',
      amec: '添加人工加分日志',
      rom: '修改人工加分日志',
      ms: '修改成功',
      as: '新增成功',
      dic: '是否确认删除人工加分日志编号为"{ids}"的数据项?',
      cpe: '确认处理Excel并下载，数据量大的时候会延迟，请耐心等待...',
      mecl: '人工加分日志',
    ...
    memberWithdrawLog:{
      ...
      mid: '会员ID',
      fbnm: '字体蓝色:(正常会员)',
      fptn: '字体粉色:(测试号,超管号,稀有号)',
      fran: '字体红色:(套利号)',
      forn: '字体橙色:(审查号)',
      dn: '入款姓名',
      ind: '入款姓名不包含提现姓名则整行颜色变粉色',
      nsd: '今日入款成功数',
      tcw: '今日入款成功数大于10次则整行颜色变粉色',
      ior: '出入款比',
      frio: '字体红色:出入款比大于10',
      bcr: '投注打码比',
      ibcr: '投注打码比小于等于风控打码倍数则整行颜色变粉色',
      payee: '收款人',
      ban: '银行账号',
      bank: '银行',
      ba: '银行归属地',
