...
<script>
import { listActivityMemberInfo, getActivityMemberInfo, delActivityMemberInfo, addActivityMemberInfo, updateActivityMemberInfo, exportActivityMemberInfo } from "@/api/platform-web/activity/activityMemberInfo";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除会员推广管理编号为"' + ids + '"的数据项?', "警告", {
