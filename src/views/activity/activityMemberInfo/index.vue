  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item>
        ...
        <el-button type="primary" icon="el-icon-search" size="mini" @click="handleQueryIp">ip重复检查</el-button>
        <el-button type="primary" icon="el-icon-search" size="mini" @click="handleQuery(1)">手机序列号检查</el-button>
      </el-form-item>
    </el-form>
