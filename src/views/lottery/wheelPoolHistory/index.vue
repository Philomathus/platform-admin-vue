<template>
  <div class="app-container">
    ...
    <div v-loading="totalLoading">
      ...
      <el-button  type="primary" icon="el-icon-search" size="small" @click="listCount()" style="margin-left: 15px" plain>统计查询</el-button>
    </div>
...
<!--    search form 搜索表格 -->
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px" style="margin-top: 15px;">
      ...
      <el-form-item>
        <el-button type="primary" icon="el-icon-search" size="small" @click="handleQuery" plain>搜索</el-button>
