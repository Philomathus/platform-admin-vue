<template>
  <div class="app-container">
              ...
              <span slot="label">
                ...
                <el-tooltip placement="top">
                  <div slot="content">
                    ...
                    <br/>Class类调用示例：com.live.quartz.task.RyTask.ryParams('ry')
    ...
    <!-- 任务日志详细 -->
    <el-dialog v-dialogDrag :close-on-click-modal="false" :title="任务详细" :visible.sync="openView" width="700px" append-to-body>
...
<script>
import { listJob, getJob, delJob, addJob, updateJob, exportJob, runJob, changeJobStatus } from '@/api/platform-web/monitor/job'
  ...
  methods: {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有定时任务数据项?', '警告', {
        ...
        this.downloadExcel(response, '定时任务')
      }).catch(() => {
      })
    }
  }
