  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="变化类型" prop="type">
        <el-select v-model="queryParams.type" placeholder="请选择变化类型" clearable size="small">
      ...
      <el-form-item label="变化前余额" prop="totalBefore">
        <el-input
          v-model="queryParams.totalBefore"
      ...
      <el-form-item label="备注订单号" prop="markorder">
        <el-input
          v-model="queryParams.markorder"
          placeholder="请输入备注订单号"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
...
<script>
import { listLogMoney, getLogMoney, delLogMoney, addLogMoney, updateLogMoney, exportLogMoney } from "@/api/platform-web/pay/logMoney/logMoney";
