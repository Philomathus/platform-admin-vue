<template>
  <div class="app-container">
    ...
    <el-button type="success" @click="copy2">剩余总金额 {{ this.totalData.subMoney - this.totalData.handlingfeeTotal || 0 }}</el-button>
    ...
    <el-table :stripe="true" v-loading="loading" :data="memberPayJourList" :highlight-current-row="true">
      ...
      <el-table-column label="剩余金额" min-width="80" align="center" prop="remaining"/>
