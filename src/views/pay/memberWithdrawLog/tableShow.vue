...
<!-- update code form -->
    ...
    <div class="fundsInfo">
      ...
      <div class="mount" style="width: 80%">
        ...
        <div class="font">线下充值金额: {{ parseFloat(data.线下充值金额).toFixed(2) }}</div>
        <div class="font">USDT充值金额: {{ parseFloat(data.USDT充值金额).toFixed(2) }}</div>
        ...
        <div class="font">提现金额: {{ parseFloat(data.会员提现金额).toFixed(2) }}</div>
      </div>
    </div>
