<template>
  <div class="app-container">
    ...
    />
    <!-- 预览界面 -->
    <el-dialog v-dialogDrag :close-on-click-modal="false" :title="preview.title" :visible.sync="preview.open" width="80%" top="5vh" append-to-body>
...
<script>
import { listTable, previewTable, delTable, genCode, synchDb } from '@/api/platform-web/tool/gen'
  ...
  methods: {
    ...
    handleGenTable(row) {
      ...
      if (row.genType === '1') {
        ...
        downLoadZip('/tool/gen/batchGenCode?tables=' + tableNames, '77tv')
      }
    },
    /** 同步数据库操作 */
    handleSynchDb(row) {
